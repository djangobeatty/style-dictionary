...
/**
 * File extensions that are loaded as a module (ESM or CJS) with a dynamic import
 * rather than being parsed as JSON.
 *
 * The TypeScript extensions (.ts, .mts, .cts) rely on the runtime's native TypeScript
 * support: Deno and Bun support this out of the box, Node.js supports it since v22.6
 * behind the --experimental-strip-types flag and enables it by default since v23.6.
 */
