...
| log           | String (optional)        | What to do with warnings such as token collisions: `"warn"` (default) logs them, `"error"` throws an error instead.                                                                                                                                                                                                                        |
| verbosity     | String (optional)        | The verbosity of the logging: `"verbose"` shows every collision and reference error, `"default"` only shows a concise message, `"silent"` suppresses all logging. Can also be set per platform.                                                                                                                                            |
