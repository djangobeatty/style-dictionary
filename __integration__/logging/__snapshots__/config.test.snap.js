...
Collisions detected at: size.padding.small, size.padding.medium, size.padding.large, size.padding.xl
...
snapshots["integration > logging > config > property value collisions should throw when warnings are set to error"] = 
`
Property Value Collisions:
Collisions detected at: size.padding.small, size.padding.medium, size.padding.large, size.padding.xl
...
`;
/* end snapshot integration > logging > config > property value collisions should throw when warnings are set to error */

snapshots["integration > logging > config > property value collisions should show all collisions when verbose"] = 
`
Property Value Collisions:
...
`;
/* end snapshot integration > logging > config > property value collisions should show all collisions when verbose */
