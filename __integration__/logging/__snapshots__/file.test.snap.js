...
`
css
✔︎ __integration__/build/nameCollisions.css
...
Run with --verbose to see the full details of these 19 collisions.
...
`
css
✔︎ __integration__/build/filteredReferences.css
...
snapshots["integration logging file should show all name collisions when verbose"] = 
`
css
✔︎ __integration__/build/nameCollisions.css
⚠️ __integration__/build/nameCollisions.css
...
* platform transforms/transformGroups affecting names, especially when removing specificity
* overly inclusive file filters`;
/* end snapshot integration logging file should show all name collisions when verbose */

snapshots["integration logging file should show all filtered references when verbose"] = 
`
css
✔︎ __integration__/build/filteredReferences.css
⚠️ __integration__/build/filteredReferences.css
...
color.core.blue.0
This is caused when combining a filter and \`outputReferences\`.`;
/* end snapshot integration logging file should show all filtered references when verbose */
