...
While building nameCollisions.css, 19 token name collisions were found; output may be unexpected. Re-run with verbosity "verbose" (e.g. --verbose when using the CLI) to see details.`;
/* end snapshot integration logging file should warn user of name collisions */

snapshots["integration logging file should show every name collision with verbose logging"] = 
`
css
⚠️ __integration__/build/nameCollisions.css
While building nameCollisions.css, 19 token name collisions were found; output may be unexpected.
...
/* end snapshot integration logging file should show every name collision with verbose logging */
...
While building filteredReferences.css, 7 filtered out token references were found; output may be unexpected. Re-run with verbosity "verbose" (e.g. --verbose when using the CLI) to see details.`;
/* end snapshot integration logging file should warn user of filtered references */

snapshots["integration logging file should show every filtered out reference with verbose logging"] = 
`
css
⚠️ __integration__/build/filteredReferences.css
While building filteredReferences.css, 7 filtered out token references were found; output may be unexpected. Here are the references that are used but not defined in the file:
...
/* end snapshot integration logging file should show every filtered out reference with verbose logging */
